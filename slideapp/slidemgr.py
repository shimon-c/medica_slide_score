...
class SlideMgr:
    ...
    def work_on_slides(self, root_dir: str = None, file_exten='ndpi'):
        pred = self.predictor
...
if __name__ == "__main__":
    args = parse_args()
    sm_app = SlideMgr(input_dir=args.slides_dir,classfier_path=args.model_path, output_dir=args.out_dir)
    sm_app.work_on_slides(root_dir=args.slides_dir)